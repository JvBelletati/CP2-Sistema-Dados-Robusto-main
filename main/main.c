...
// --- Seus dados ---
#define NOME_ALUNO "João Victor Belletati Corrêa"
#define RM_ALUNO "88410"
// ------------------
...
void app_main(void) {
    printf("{João Victor Belletati Corrêa-RM:88410} [SISTEMA] Iniciando CP2 - Sistema de Dados Robusto.\n");
    xFilaDeDados = xQueueCreate(TAMANHO_FILA, sizeof(int));
    if (xFilaDeDados == NULL) {
        printf("{João Victor Belletati Corrêa-RM:88410} [SISTEMA] Falha ao criar a fila.\n");
        return;
    }
    ...
    printf("{João Victor Belletati Corrêa-RM:88410} [SISTEMA] Inicializacao concluida. WDT ja ativo.\n");
